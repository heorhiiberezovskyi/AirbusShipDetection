...
def main(args):
    ...
    elif args.precision == 'tf32_medium':
        print('Training in tf32 medium precision')
...
if __name__ == '__main__':
    ...
    # 24_25 - random resize from 768 to 256 and ship centered crop (sampling random)
    # 25_26 - random resize from 768 to 256 and ship centered crop (sampling balanced)
    ...
    parser.add_argument("--sampling", type=str, help="Random or balanced", default='random',
    ...
    parser.add_argument("--precision", type=str, help="Precision to train", default='fp32',
                        choices=['fp32', 'tf32_high', 'tf32_medium'])
